      ...
      <div class="box">        
        <div class="box-body">
			...
			<div class="row" style="margin-bottom: 10px">
				<div class="col-md-4">
					<h2 style="margin-top:0px">Analisa</h2>
				</div>
				...
				<div class="col-md-4 text-right">
					<?php echo anchor(site_url('analisa/create/?alamat_website='), '<i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;Create', 'class="btn btn-primary"'); ?>
			</div>
			</div>
