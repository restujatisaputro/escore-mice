...
<head>
  ...
  <link rel="icon" href="https://green.adiva.click/images/icon_green.png" type="image/gif" >
  
  <title>Automated Checlist</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="admin" class="logo">
      ...
      <span class="logo-lg"><b>Automated Checklist</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">          
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('images/icon_green.png') ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $username; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url('images/icon_green.png') ?>" class="img-circle" alt="User Image">
