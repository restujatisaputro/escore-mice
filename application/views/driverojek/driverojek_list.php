...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Driver Ojek</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <div class="box">        
        <div class="box-body">
			...
			<!-- Menampilkan Data Driver Ojek -->
			<div class="row" style="margin-bottom: 10px">
				<div class="col-md-4">
					<h2 style="margin-top:0px">Driver Ojek</h2>
				</div>
				...
				<div class="col-md-4 text-right">
					<?php echo anchor(site_url('driverojek/create'), '<i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;Create', 'class="btn btn-primary"'); ?>
			</div>
			</div>
