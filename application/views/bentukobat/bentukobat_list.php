...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Bentuk Obat</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <div class="box">        
        <div class="box-body">
			...
			<!-- Tampil Data Bentuk Obat -->
			<div class="row" style="margin-bottom: 10px">
				<div class="col-md-4">
					<h2 style="margin-top:0px">Bentuk Obat</h2>
				</div>
				...
				<div class="col-md-4 text-right">
					<?php 
						...
						echo anchor(site_url('bentukobat/create'), '<i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;Create', 'class="btn btn-primary"'); 
					?>
				</div>
			</div>
				...
				$(document).ready(function() {
					$.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
					   ...
					   var t = $("#mytable").dataTable({
								...
								processing: true,
								serverSide: true,
								ajax: {"url": "bentukobat/json", "type": "POST"},
								columns: [
									{
										"data": "id_bentukobat",
										"orderable": false
									},
									{"data": "kode_bentukobat"},
									{"data": "bentuk_obat"},
									{
										"data" : "action",
										"orderable": false,
