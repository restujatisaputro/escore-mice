...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">User Driver</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="box">        
        <div class="box-body">
			...
			<div class="row" style="margin-bottom: 10px">
				<div class="col-md-4">
					<h2 style="margin-top:0px">User Driver</h2>
				</div>
				...
				<div class="col-md-4 text-right">
					<?php 
						...
						echo anchor(site_url('userdriver/create'), 'Create', 'class="btn btn-primary"'); 
					?>
			</div>
			</div>
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					var t = $("#mytable").dataTable({
						...
						processing: true,
						serverSide: true,
						ajax: {"url": "userdriver/json", "type": "POST"},
						columns: [
							{
								"data": "no_handphone",
								"orderable": false
