    ...
    <section class="content">
      ...
      <div class="box">        
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <h2 style="margin-top:0px">Persediaan Obat</h2>
            </div>
            ...
            <div class="col-md-4 text-right">
                <?php echo anchor(site_url('persediaan/create/?cari=&id_pembelianobat=0'), 'Tambah', 'class="btn btn-primary"'); ?>
	    </div>
        </div>
        <table class="table table-bordered table-striped" id="mytable">
            <thead>
                <tr>
					...
					<th><center>Kadarluasa</center></th>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "persediaan/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_persediaanobat",
                            "orderable": false
                        },						
						{"data": "tanggal"},
						{"data": "nama_obat"},
