    ...
    <section class="content">
      ...
      <div class="box">        
        <div class="box-body">
			...
			<!-- Tampil Data Indikator -->
			<div class="row" style="margin-bottom: 10px">
				<div class="col-md-4">
					<h2 style="margin-top:0px">Indikator</h2>
				</div>
				...
				<div class="col-md-4 text-right">
					<?php 
						// Button untuk melakukan create indikator
						echo anchor(site_url('indikator/create'), '<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Indikator', 'class="btn btn-primary"'); 
					?>
				</div>
			</div>
