    ...
    <section class="content">
      ...
      <div class="box">        
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <h2 style="margin-top:0px">Marketing</h2>
            </div>
            ...
            <div class="col-md-4 text-right">
                <?php echo anchor(site_url('marketing/create'), 'Create', 'class="btn btn-primary"'); ?>
	    </div>
        </div>
        <table class="table table-bordered table-striped" id="mytable">
            <thead>
                <tr>
					...
					<th><center>ID Marketing</center></th>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "marketing/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_marketing",
                            "orderable": false
