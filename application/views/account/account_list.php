        ...
        <div class="box-body">
			...
			<div class="row" style="margin-bottom: 10px">
				...
				<div class="col-md-4 text-right">
					<?php 
						// Button untuk melakukan create account
						echo anchor(site_url('account/create'), '<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Account', 'class="btn btn-primary"'); 
					?>
				</div>
			</div>
				...
				$(document).ready(function() {
					$.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
					   ...
					   var t = $("#mytable").dataTable({
								...
								processing: true,
								serverSide: true,
								ajax: {"url": "account/json", "type": "POST"},
								columns: [
									{
										"data": "kode_account",
										"orderable": false
