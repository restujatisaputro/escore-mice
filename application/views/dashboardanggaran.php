...
<head>
  ...
  <link rel="icon" href="https://simo.adiva.click/images/icon_puskesmas_bulat.png" type="image/gif" >
  
  <title>SIMO-Dinkes Inhil</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="admin" class="logo">
      ...
      <span class="logo-mini"><b>SIMO</b></span>
        ...
        <ul class="nav navbar-nav">          
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('images/icon_puskesmas_bulat.png') ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $username; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url('images/icon_puskesmas_bulat.png') ?>" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo base_url('images/simo.png') ?>" class="img-circle" alt="User Image">
        </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box-footer">
         <center>SIMO <a href="https://sikda.inhilkab.go.id"><strong>Dinas Kesehatan Kab. Inhil</strong></a> - 2022</center>
        </div>
        <!-- /.box-footer-->
      </div>
      <!-- /.box -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="https://adiva.click">Adiva Studio</a>.</strong> All rights
    reserved.
  </footer>
