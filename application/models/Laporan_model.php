...
/* Lokasi File : ./application/models/Laporan_model.php    */
/* Copyright   : CV Adiva                                  */
/* Publish     : Green                                     */
/*---------------------------------------------------------*/
...
class Laporan_model extends CI_Model
{
	...
	// Tabel data dengan nama laporan
    function json() {		
        ...
        $this->datatables->add_column('action', anchor(site_url('laporan/read/$1'),'<button type="button" class="btn btn-primary"><i class="fa fa-file-o" aria-hidden="true"></i></button>')."  ".anchor(site_url('laporan/update/$1'),'<button type="button" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i></button>')."  ".anchor(site_url('laporan/delete/$1'),'<button type="button" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_analisa');
